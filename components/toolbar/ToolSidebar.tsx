...
export const ToolSidebar: React.FC = () => {
	...
	return (
		<div className="flex h-full">
			<div className="w-16 h-full bg-linear-to-b from-card via-card to-muted/40 border-r border-border/60 flex flex-col items-center py-3 gap-1 animate-fade-in overflow-y-auto scrollbar-thin">
