...
const tools: ToolConfig[] = [
  ...
  { 
    ...
    label: 'Move Tool', 
    shortcut: 'V',
    description: 'Select and move layers, selections, and other elements on the canvas.',
    category: 'selection'
  },
  { 
    id: 'marquee', 
  ...
  { 
    ...
    label: 'Lasso Tool', 
    shortcut: 'L',
    description: 'Draw freehand selections around objects. Double-click or press Enter to close.',
    category: 'selection'
  },
  { 
    id: 'magicwand', 
    ...
    label: 'Magic Wand', 
    shortcut: 'W',
    description: 'Select areas of similar color. Adjust tolerance in options to control sensitivity.',
    category: 'selection'
  },
  ...
  { 
    ...
    label: 'Brush Tool', 
    shortcut: 'B',
    description: 'Paint strokes with customizable brush tips. Use [ ] to adjust size, Shift+click for straight lines.',
    category: 'drawing'
  },
  { 
    id: 'pencil', 
    ...
    label: 'Pencil Tool', 
    shortcut: 'N',
    description: 'Draw hard-edged freehand lines. Ideal for pixel art and precise work.',
    category: 'drawing'
  },
  { 
    id: 'eraser', 
    ...
    label: 'Eraser Tool', 
    shortcut: 'E',
    description: 'Erase pixels to transparency or background color. Hold Alt to sample background.',
    category: 'drawing'
  },
  { 
    id: 'fill', 
    ...
    label: 'Paint Bucket', 
    shortcut: 'G',
    description: 'Fill areas with the foreground color. Adjust tolerance for color matching range.',
    category: 'drawing'
  },
  { 
    id: 'gradient', 
    ...
    label: 'Gradient Tool', 
    shortcut: 'G',
    description: 'Create smooth color transitions. Click and drag to define gradient direction.',
    category: 'drawing'
  },
  { 
    id: 'eyedropper', 
    ...
    label: 'Eyedropper', 
    shortcut: 'I',
    description: 'Sample colors from the canvas. Alt+click with any tool for quick sampling.',
    category: 'drawing'
  },
  { 
    id: 'clone', 
    ...
    label: 'Clone Stamp', 
    shortcut: 'S',
    description: 'Paint with pixels from another area. Alt+click to set source point.',
    category: 'drawing'
  },
  { 
    id: 'healing', 
    ...
    label: 'Healing Brush', 
    shortcut: 'J',
    description: 'Remove imperfections by blending with surrounding pixels. Great for photo retouching.',
    category: 'drawing'
  },
  { 
    id: 'blur', 
    ...
    label: 'Blur Tool', 
    shortcut: 'R',
    description: 'Soften edges and reduce detail. Useful for depth of field effects.',
    category: 'drawing'
  },
  ...
  { 
    ...
    label: 'Polygon Tool', 
    shortcut: 'U',
    description: 'Create multi-sided shapes. Set number of sides in tool options.',
    category: 'shape'
  },
  { 
    id: 'line', 
  ...
  { 
    ...
    label: 'Pen Tool', 
    shortcut: 'P',
    description: 'Create precise paths with anchor points. Essential for complex selections and shapes.',
    category: 'shape'
  },
  { 
    id: 'text', 
  ...
  { 
    ...
    label: 'Hand Tool', 
    shortcut: 'H',
    description: 'Pan around the canvas. Hold Space with any tool for quick access.',
    category: 'navigation'
  },
  { 
    id: 'zoom', 
...
export const ToolSidebar: React.FC = () => {
  const { activeTool, setActiveTool, canUndo, canRedo, undo, redo } = useArtStudioStore();
            ...
            >
              <div className="space-y-1.5">
                <div className="flex items-center justify-between gap-4">
                  ...
                  <kbd className="px-1.5 py-0.5 text-xs bg-muted rounded font-mono">{tool.shortcut}</kbd>
                </div>
  ...
  return (
    <div className="w-14 panel-glass flex flex-col items-center py-3 gap-1 animate-fade-in overflow-y-auto scrollbar-thin">
      {/* Selection Tools */}
      ...
      <Tooltip delayDuration={400}>
        ...
        <TooltipContent side="right" className="max-w-[280px] p-3" sideOffset={8}>
          <div className="space-y-1.5">
            <div className="flex items-center justify-between gap-4">
          ...
          <TooltipContent side="right" className="max-w-[280px] p-3" sideOffset={8}>
            <div className="space-y-1.5">
              <div className="flex items-center justify-between gap-4">
                ...
                <kbd className="px-1.5 py-0.5 text-xs bg-muted rounded font-mono">X</kbd>
              </div>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Foreground and background colors. Press X to swap, D to reset to defaults.
              </p>
            </div>
          </TooltipContent>
        </Tooltip>
