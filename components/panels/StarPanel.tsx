...
export const StarPanel = () => {
	const { brushSettings, setBrushSettings, primaryColor, secondaryColor } =
		useArtStudioStore();
	...
	const updateStarSetting = (key: string, value: any) => {
		setBrushSettings({
			[`star${key.charAt(0).toUpperCase() + key.slice(1)}`]: value,
		});
	};
		...
		return (
			<svg width={size} height={size} className="mx-auto">
				<path
					d={path.join(" ")}
					fill={
						starSettings.fillType === "none"
							? "transparent"
							: starSettings.fillColor
					}
					...
					<TabsContent value="basic" className="space-y-4 pt-4">
						...
						<div className="space-y-2">
							...
							<Slider
								...
								onValueChange={([value]) =>
									updateStarSetting("outerRadius", value)
								}
								className="w-full"
							/>
						</div>
						...
						<div className="space-y-2">
							...
							<Slider
								...
								onValueChange={([value]) =>
									updateStarSetting("innerRadius", value)
								}
								className="w-full"
							/>
						</div>
						...
						<div className="space-y-2">
							...
							<Slider
								...
								onValueChange={([value]) =>
									updateStarSetting("rotation", value)
								}
								className="w-full"
							/>
						</div>
					...
					<TabsContent value="advanced" className="space-y-4 pt-4">
							...
							<div className="grid grid-cols-3 gap-2">
								{(["solid", "gradient", "none"] as const).map((type) => (
									<Button
										key={type}
										variant={
											starSettings.fillType === type ? "default" : "outline"
										}
										size="sm"
						...
						<div className="space-y-2">
							...
							<Slider
								...
								onValueChange={([value]) =>
									setBrushSettings({ strokeWidth: value })
								}
								className="w-full"
							/>
						</div>
						...
						<div className="space-y-2">
							...
							<Slider
								...
								onValueChange={([value]) =>
									updateStarSetting("cornerRadius", value)
								}
								className="w-full"
							/>
						</div>
