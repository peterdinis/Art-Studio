		...
		>
			...
			<ChevronUp
				className={cn(
					...
					hovered ? "text-[#31a8ff] translate-y-[-2px]" : "text-[#b0b0b0]",
				)}
			/>
			...
			{hovered && (
				<>
					...
					<div
						className="absolute top-0 right-0 w-2 h-2 border-t border-r border-[#31a8ff] animate-pulse"
						style={{ animationDelay: "0.1s" }}
					/>
					<div
						className="absolute bottom-0 left-0 w-2 h-2 border-b border-l border-[#31a8ff] animate-pulse"
						style={{ animationDelay: "0.2s" }}
					/>
					<div
						className="absolute bottom-0 right-0 w-2 h-2 border-b border-r border-[#31a8ff] animate-pulse"
