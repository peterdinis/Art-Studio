    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#1e1e1e]/95 backdrop-blur-sm">
      <div className="relative">
        ...
        <div className="relative w-32 h-32 mb-8">
          ...
          <div className="absolute -top-1 -right-1 w-6 h-6 border-t-2 border-r-2 border-[#1473e6] rounded-tr-lg animate-spin" style={{ animationDelay: "0.5s" }} />
          <div className="absolute -bottom-1 -left-1 w-6 h-6 border-b-2 border-l-2 border-[#31a8ff] rounded-bl-lg animate-spin" style={{ animationDelay: "1s" }} />
          <div className="absolute -bottom-1 -right-1 w-6 h-6 border-b-2 border-r-2 border-[#1473e6] rounded-br-lg animate-spin" style={{ animationDelay: "1.5s" }} />
        </div>
        
        {/* Loading text */}
        <div className="text-center">
          <h3 className="text-xl font-medium text-white mb-2">ArtStudio Pro</h3>
          <p className="text-sm text-[#b0b0b0] mb-4">Loading creative workspace...</p>
          ...
          <div className="mt-6 grid grid-cols-3 gap-2">
            {["Tools", "Brushes", "Layers", "Filters", "Colors", "History"].map((module, i) => (
              <div
                key={module}
