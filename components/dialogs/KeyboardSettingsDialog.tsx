...
const shortcutCategories: ShortcutCategory[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { keys: ['Shift'], description: 'Constrain Proportions (while dragging)' },
      { keys: ['Alt/⌥'], description: 'Transform from Center (while dragging)' },
    ],
  },
  {
    name: 'Layers',
      ...
      <DialogContent className="max-w-4xl max-h-[85vh] p-0 gap-0">
        <DialogHeader className="p-6 pb-4">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            ...
            or <Badge variant="outline" className="mx-1 font-mono text-xs">?</Badge> to toggle this panel
          </p>
        </DialogHeader>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-1.5">
              {[
                ...
                { action: 'Alt/⌥ + Click', description: 'Subtract from Selection' },
                { action: 'Double Click', description: 'Edit Text / Open Settings' },
