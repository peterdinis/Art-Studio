				...
				<div className="max-w-4xl mx-auto text-center">
					...
					>
						...
						<p className="text-xl text-gray-300 max-w-2xl mx-auto">
							It seems you tried to access a layer that doesn't exist. It might
						...
						{[1, 2, 3, 4].map((i) => (
							...
							>
								<div className="flex items-center gap-2">
									<div
										className={`w-8 h-8 rounded ${i === 1 ? "bg-cyan-500/20" : i === 2 ? "bg-purple-500/20" : i === 3 ? "bg-pink-500/20" : "bg-blue-500/20"}`}
									/>
